...
test('asset URLs remain relative to the copied src/assets dist layout', () => {
  ...
  assert.match(ASH_SERVANT_ATLAS_URL, /\/assets\/characters\/ash-servant\/ash-servant-states-v2\.webp$/);
  assert.match(DEMONESS_ATLAS_URL, /\/assets\/characters\/demoness\/demoness-states-v2\.webp$/);

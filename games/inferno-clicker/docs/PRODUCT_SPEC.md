...
| Физическая усталость от чрезмерного tapping | Высокая | Высокое | медиана >6 эффективных taps/с в течение 30 с либо жалоба на усталость у >20% тестеров | первые 3 taps скользящей секунды дают полную силу, taps 4–8 — убывающую; бонусы за ритм и паузу; баланс прохождения на 3–5 taps/с | Product/Game Designer + QA |
